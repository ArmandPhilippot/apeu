...
You can choose to let the viewport or container width adapting the card styles with `adaptTo`. This is useful to control both when the inline borders are visible and the shadow direction when `elevation` is provided.

### Based on viewport

<CodePreview
  code={`<Card adaptTo="viewport">
    <h3 slot="heading">The card title</h3>
    <p>Ut consequuntur modi. Accusantium quia unde sint suscipit ipsum. Sunt
    voluptates earum ea cumque eligendi voluptate iste architecto dolores.
    Sit impedit cum non voluptates at qui ducimus eveniet reiciendis. Ad
  ...
  label="Adapting the styles to the viewport"
  lang="astro"
>
  <Card adaptTo="viewport">
    <h3 slot="heading">The card title</h3>
...
<CodePreview
  ...
  label="Adapting the styles to its container"
  lang="astro"
>
  <Card adaptTo="container">
    <h3 slot="heading">The card title</h3>
